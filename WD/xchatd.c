...
#define STAND_ALONE              /* ¤£·f°t BBS ¿W¥ß°õ¦æ */

#define SERVER_USAGE
#define WATCH_DOG
#define  MONITOR_                 /* ºÊ·þ chatroom ¬¡°Ê¥H¸Ñ¨MªÈ¯É */
#define  DEBUG                   /* µ{¦¡°£¿ù¤§¥Î */
...
#define MAIN_TOPIC      "Pentium2 ¶]ªº§Ö..."
  ...
  char *msg;
{
  ...
  {
    send_to_user(cu, "¡° ½Ð¿é¤J 1~7 ªº¼Æ¦r , °£¤F 4 ¤§¥~", 0, MSG_MESSAGE);
    return;
  }
...
{
  if (common_client_command)
    send_to_user(cu, "­·¹Ð¯ù¼Ó 4 21", 0, MSG_CHATROOM);
}
...
static char *chat_msg[] =
{
  ...
  "[/p]ager", "¤Á´«©I¥s¾¹",
  "[/q]uery <user>", "¬d¸ßºô¤Í",
  "[/r]oom  [/t]ape", "¦C¥X¤@¯ë½Í¤Ñ«Ç  ¶}Ãö¿ý­µ¾÷",
  "[/u]nignore <user>", "¨ú®ø©¿²¤",
...
static ChatAction party_data[] =
{
  ...
  {
    "bearhug", "ºò©ê", "¥Î¤O§â", "©êªº§Ö­n²¿®§¤F"
  },
  {
    "bearnod", "¥Î¤OÂIÀY","¹ïµÛ", "«÷©RªºÂIÀY¦p·o»["
  },
  {
  ...
  {
    "catleg", "¿ß»L", "¤j³Û¡G¡u¸U¯àªº", "½Ð½ç»P§Ú¯«©_ªº¤O¶q¡v"
  },
  {
    "clap", "¹ª´x", "¹ï", "¥Î¤Oªº¹ª´x¨ì¨â¤âµo¸~"
  },
  {
    "claw", "§ì§ì", "¸ò³¥¿ß­É¨Ó¿ß¤ö¡A§â", "ªºÁy¤W§ì¥X¤@¹D¤@¹Dªº¦åµ·"
  },
  {
    "comfort", "¦w¼¢", "·Å¨¥¦w¼¢", "»¡¡G¡u¤£­ú¡A¤£­ú¡A§Ú·|­t³dªº¡C¡v"
  },
  {
  ...
  {
    "cry", "¤j­ú", "­ú­Ë¦b", "ªºÃh¸Ì"
  },
  {
    "dance", "¸õ»R", "©ÔµÛ", "ªº¤â§Ö¼Öªº¸õ°_»R¨Ó"
  },
  {
    "destroy", "·´·À", "²½°_¤F¡y·¥¤j·´·À©G¤å¡z¡AÅF¦V", ""
  },
  {
    "dogleg", "ª¯»L", "¹ï", "ªº´º¥õ¡A¦³¦p·Ê·Ê¦¿¤ô¡A¥Ã¤£¤î®§¡K"
  },
  {
    "drivel", "¬y¤f¤ô", "¬ÝµÛ", "©Ã©Ãªºµo§b¡A¤f¤ô³£ºw¤U¨Ó¤F"
  },
  {
    "envy", "¸r¼}", "¹ïµÛ", "¬yÅS¥X¸r¼}ªº²´¥ú"
  },
  {
  ...
  {
    "forgive", "­ì½Ì", "¹ï", "»¡¡G¡u§O¤Ó¦b·N°Õ¡A¤p¨Æ¤@¼Î¡v"
  },
  { 
    "french", "ªk¦¡§k", "©M", "ªº¦ÞÀYªÈÄñ¦b¤@°_¼ö±¡ªº¿Ë§kµÛ"
  },
  {
    "gag", "«Ê¼L", "¥Î½¦±a§â", "ªº¼L¤Ú¶K°_¨Ó¤£Åý¥L»¡¸Ü"
  },
  {
    "giggle", "¦Y¯º", "¹ïµÛ", "¦Y¦Yªº°½¯º¤F´XÁn"
  },
  {
  ...
  {
    "hospitl", "°eÂå°|", "¬Ý", "¤w¸g©a©a¤@®§¡A»°§Ö§â¥L°e¥hÂå°|"
  },
  {
    "hug", "¾Ö©ê", "·Å¬Xªº±N", "¾Ö¤JÃh¤¤"
  },
  {
    "jab", "ÂW¤H", "®³°_¦BÆp¡A©¹", "ªº¨º¸Ì¨ë¤F¤U¥h"
  },
  {
    "judo", "¹LªÓºL", "§ì¦í¤F", "ªº¦çÃÌ¡Aµ¹¥L¤@°O¹LªÓºL¡I"
  },
  {
    "kickout", "½ð¥X¥h", "§â", "½ð¦^¥D¿ï³æ­±¾À«ä¹L"
  },
  {
    "kick", "½ð¤H", "¤@¸}§â", "¿å¶i²H¤ôªe¸Ì"
  },
  {
    "kiss", "»´§k", "µ¹", "¤@­Ó·Å¬Xªº§k"
  },
  {
    "laugh", "¼J¯º", "¤jÁnªº¼J¯º", "¡G¡u¯u¬O²Â§o¡v"
  },
  {
  ...
  {
    "lorelie", "®ü§¯", "©I³ê¥X®ü§¯¡A¥ÎºqÁn§â", "À~¦º¤F¡I"
  },
  {
    "love", "ªí¥Õ", "²`±¡ªº¹ï", "»¡¡G¡u§Ú²Ä¤@¦¸¹J¨ì§A¡A´N¤£¥i¦Û©Þªº·R¤W§A¤F....¡v"
  },
  {
    "marry", "¨D±B", "±·µÛ¤E¦Ê¤E¤Q¤E¦·ª´ºÀ¦V", "¨D±B"
  },
  {
    "monica", "¤p¹Ú", "ÅÜ¨­¬°§l¦å¤k¡A©¹", "ªº²ä¤l«r¤F¤U¥h"
  },
  {
    "no", "¤£­n°Ú", "«÷©R¹ïµÛ", "·nÀY~~~~¤£­n°Ú~~~~"
  },
  {
    "nod", "ÂIÀY", "¹ïµÛ", "»´»´ªºÂI¤F¤@¤UÀY"
  },
  {
    "nudge", "³»¨{¤l", "¥Î¤â¨y©¹", "ªº°à°s¨{³»¤U¥h"
  },
  {
    "pad", "©çªÓ»H", "»´©ç", "ªºªÓ»H¡A»¡¡G¡u¦n¤p¤l¡I·Fªº¦n¡I¡v"
  },
  {
  ...
  /* Thor.0729: À³Æ[²³­n¨D */
  {
    "pinch", "À¾¤H", "¥Î¤Oªº§â", "ªº§¾ªÑÀ¾ªº¶Â«C"
  },
  {
    "roll", "¥´ºu", "©ñ¥X¦hº¸³Oªº­µ¼Ö,", "¦b¦a¤Wºu¨Óºu¥h"
  },
  {
    "protect", "«OÅ@", "¹ï", "»¡¡G¡u¨SÃö«Y¡A§Ú·|«OÅ@§Aªº¡v"
  },
  {
    "pull", "©Ô", "¦º©R¦a©Ô¦í", "¤£©ñ"
  },
  ...
  {
    "saw", "¹q¿÷", "®³¥X¹q¿÷¡A©¹", "ªº¨º¸Ì¿÷¤F¤U¥h"
  },
  {
    "shrug", "ÁqªÓ", "µL©`¦a¦V", "Áq¤FÁqªÓ»H"
  },
  {
    "sigh", "¼Û®ð", "¹ïµÛ", "²`²`ªº¼Û¤F¤@¤f®ð"
  },
  {
    "slap", "¥´¦Õ¥ú", "°Ô°Ôªº¤Ú¤F", "¤@¹y¦Õ¥ú"
  },
  {
    "smooch", "¾Ö§k", "©M", "ºòºòªº©ê¦b¤@°_±µ§k"
  },
  {
  ...
  /* Thor.0729: ¤¤°ê²á¤Ñ¤Ø-----Æ[²³­×¥¿ª© */
  {
    "sob", "¨FÅy", "¹ï", "¼«¼«ªº»¡ You S...un Of B...each¡I"
  },
  ...
  {
    "thank", "·PÁÂ", "¥Ñ°Jªº¹ï", "ªí¥Ü·PÁÂ¤§·N"
  },
  {
    "tickle", "·kÄo", "©B¼T!©B¼T!·k", "ªº¯ÞªÏºÛ"
  },
  {
    "wake", "·n¿ô", "®³°_¤@±í§N¤ô¡A©¹", "ªºÀY¤W¼å¤F¤U¥h"
  },
  {
    "wave", "´§¤â", "¹ïµÛ", "«÷©R´§¤â»¡¦A¨£"
  },
  {
    "welcome", "Åwªï", "Åwªï", "¶i¨Ó¤K¨ö¤@µf"
  },
  {
    "what", "¤°»ò", "¹ï", "»¡¡G¡u©êºp¡A§Ú¬ðµM¥¢¥h°O¾Ð¤F¡I¡v"
  },
  {
...
{
  {
    "applaud", "©ç¤â", "¥Î¤O©ç¤â¡A¹ª´x¥s¦n", NULL
  },
  {
    "ayo", "­üËç³Þ", "ºG¥s¡G¡u­üËç³Þ~~~¡v", NULL
  },
  {
    "back", "¦^¨Ó", "»Å»Åªº»¡¡G¡uI'm back¡I¡v", NULL
  },
  {
    "blood", "¦b¦å¤¤", "ºG¥s¤@Án¡A­Ë¦b¦åªy¤§¤¤", NULL
  },
  {
    "blush", "Áy¬õ", "¤£¦n·N«äªºÁy³£¬õ¤F", NULL
  },
  {
    "broke", "¤ß¸H", "ªº¤ß¯}¸H¦¨¤@¤ù¤@¤ùªº", NULL
  },                            /* Thor.0731:À³Æ[²³­n¨D */
  {
    "careles", "¨S¤H²z", "°ãª_¡G¶ã¡ã¡ã³£¨S¦³¤H²z§Ú :~~~~", NULL
  },
  {
  ...
  {
    "cough", "«y¹Â", "«y¤F´XÁn¡A¦n¹³¦b·t¥Ü¤°»ò", NULL
  },
  {
    "die", "¼ÉÀÅ", "­Ë¦b¦a¤W¡A·í³õ¼ÉÀÅ", NULL
  },
  {
    "faint", "©ü­Ë", "Å¥¨ì³o­Ó®ø®§¡A·í³õ©ü­Ë", NULL
  },
  {
    "flop", "¶^­Ë", "¼P³q¤@Án¡A¬ðµM¶^­Ë¡I", NULL
  },
  {
    "fly", "»aÃÇ", "¤j³Û¡G¡uI'm flying¡I¡v", NULL
  },
  {
    "frown", "ÂÙ¬Ü", "¬ÜÀY´ªªº¸ò¥]¤l¤@¼Ë", NULL
  },
  {
  ...
  {
    "haha", "«z«¢«¢", "¨g¯º¡G«z«¢«¢«¢.....^o^", NULL
  },
  {
    "helpme", "¨D±Ï", "¤j³Û~~~±Ï©R°Ú~~~~", NULL
  },
  {
    "hoho", "¨þ¨þ¯º", "µo¥X ³á¡ã¨þ¡ã¨þ¡ã¨þ¡ã ªº¯ºÁn", NULL
  },
  {
    "happy", "°ª¿³", "°ª¿³±o¦b¦a¤Wºu¨Óºu¥h", NULL
  },
  /* {"happy", "°ª¿³", "¢ç¢Ï¡I *^_^*", NULL}, */
  /* {"happy", "", "r-o-O-m....Å¥¤F¯u²n¡I", NULL}, */
  /* {"hurricane", "¢Ö¢÷---¢à£B¢ý--¢Ù¢é¢ö¡I¡I¡I", NULL}, */
  {
    "idle", "µo§b", "§¤¦b­ì¦aµo§b", NULL
  },
  {
    "jacky", "®Ì®Ì", "µl¤l¯ëªº®Ì¨Ó®Ì¥h", NULL
  },
  {
    "lag", "ºô¸ôºC", "¤j³Û¡G¡u¦³°÷Àt³tªº LowNet °Ú¡I¡I¡I¡v", NULL
  },
  {
    "luck", "©¯¹B", "¤j³Û¡G¡u°Ú¡IºÖ®ð°Õ¡I¡v", NULL
  },
  {
    "macarn", "¤@ºØ»R", "¶}©l¸õ°_¤F¢Ûa¢Ña¢àe¢Üa¡ã¡ã¡ã¡ã", NULL
  },
  {
    "miou", "ØpØp", "¶}©l¨g¥s¡GØpØp¤f­]¤f­]¡ã¡ã¡ã¡ã¡ã", NULL
  },
  {
    "mouth", "«ó¼L", "¼L¤Ú¹Êªº¥i¥H±¾¨â¤ç¦×¤F", NULL
  },
  {
    "nani", "«ç»ò·|", "ºG¥s¡G©`£®°Ú®º??", NULL
  },
  {
    "nose", "¬y»ó¦å", "»ó¦å¬ðµM¼Q¥X¨Ó¤F....", NULL
  },
  {
    "puke", "¹Ã¦R", "¼M°Õ¼M°Õªº¦R¤Fº¡¦a³£¬O¡C", NULL
  },
  {
    "rest", "¥ð®§", "¥ð®§¤¤¡A½Ð¤Å¥´ÂZ", NULL
  },
  {
    "reverse", "Â½¨{", "Â½¥Õ¨{¤F", NULL
  },
  {
    "room", "¶}©Ð¶¡", "©D§u¡Gr-o-O-m-r-O-¢Ý-Mmm-rR¢à........", NULL
  },
  {
    "shake", "·nÀY", "·n¤F·nÀY", NULL
  },
  {
    "sleep", "ºÎµÛ", "­w¦bÁä½L¤WºÎµÛ¤F¡A¤f¤ô¬y¶i¥h¡A¸Ì­±ªº¿ÂÃÆÀ~±o»°§Ö·h®a", NULL
  },
  {
    "so", "´NÂæ¤l", "»¡¡G¡u¨º´N¥ýÂæ§a!!¡v", NULL
  },
  {
    "sorry", "¹Dºp", "©I§q¡G¶ã°Ú!!§Ú¹ï¤£°_¤j®a,§Ú¹ï¤£°_°ê®aªÀ·|~~~~~~¶ã°Ú~~~~~", NULL
  },
  {
    "story", "Á¿¥j", "¶}©lÁ¿¥j¤F", NULL
  },
  {
    "strut", "·nÂ\\¨«", "¯ä§¾ªº¤j·n¤jÂ\\¨«¨Ó¨«¥h", NULL
  },
  {
    "suicide", "¦Û±þ", "®³¥XªZ¤h¤M¤Á¸¡", NULL
  },
  {
    "tea", "ªw¯ù", "ªw¤F³ý¦n¯ù¡AÄ~Äò«¢©Ô¤U¥h", NULL
  },
  {
  ...
  {
    "wawa", "«z«z", "©ñÁn¤j­ú¡G«z«z«z~~~~~!!!!!  ~~~>_<~~~", NULL
  },
  {
    "www", "¨L¨L", "¨L¨L¨L....¥s­Ó¤£°±", NULL
  },
  {
    "ya", "³Ó§Q", "¤ñ¤F¤@­Ó³Ó§Q¤â¶Õ¡G¡uYa!¡v", NULL
  },
  {
  ...
  ChatUser *cu;
{
  ...
  else
  {
    ...
    if (*cmd == '-')
      ...
      else;                     /* ¤£¬O common client ¦ý°e¥X common client
                                 * «ü¥O -> °²¸Ë¨S¬Ý¨ì */
