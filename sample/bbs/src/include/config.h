...
#define BOARDNAME       "­·»P¹Ð®Jªº¹ï¸Ü-ªÅµL¤@ª«ª©"		/* ¤¤¤å¯¸¦W */
#define BBSNAME         "WD-P BBS"		/* ­^¤å¯¸¦W */
#define MYHOSTNAME      "wdbbs.net"			/* ºô§} */
#define MYIP		"140.129.79.234"		/* IP */
#define MYVERSION       "Pure WD"			/* µ{¦¡ª©¥» */
#define MYBBSID         "WD-P"				/* Âà«H¥N½X */
#define BBSHOME         "/home/bbs"			/* BBS ªº®a */
#define BBSUSER         "bbs"
#define BBSUID          9999
#define BBSGID          99
#define TAG_VALID	"[WD-P BBS]To "	
