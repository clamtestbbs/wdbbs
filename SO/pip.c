...
char *menuname[8][2]={
 ...
 {"   ",
  "[1;44;37m  ¯S®í¿ï³æ  [46m[1]¬PªÅÂå°| [2]´Aµn®p [3]¾Ô°«­×¦æ [4]«ô³XªB¤Í [5]¬Ó®c [6]§ä¤H³æ¬D [Q][m"},
...
/*  ¢u¢w¢w¢w¢w¢q¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢t*/  
    ...
    else if(class<50 && class>=25)
    {
      ...
      pressanykey("®a¨Æ´¶´¶³q³q°Õ..¥i¥H§ó¦nªº..¥[ªo..");      
    }    
    else if(class<25)
    {
...
/*  ¢u¢w¢w¢w¢w¢q¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢t*/
    ...
    else if(class<50)
    {
      ...
      pressanykey("«ÜÁV¿|³á..§A¸n¤£¦í¤pªB¤Í­C...");      
    }        
    d.money+=workmoney;
    d.workB+=1;
    return 0;
...
/*  ¢u¢w¢w¢w¢w¢q¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢t*/
    ...
    if(class>=95)
    {
      ...
      pressanykey("®ÈÀ]¨Æ·~»]»]¤é¤W..§Æ±æ§A¦A¹L¨Ó...");
    }
    ...
    else if(class<80 && class>=60)
    {
      ...
      pressanykey("´¶´¶³q³q°Õ..¥i¥H§ó¦nªº..¥[ªo..");      
    }    
    else if(class<60)
    {
      d.homework+=rand()%2+1;
      ...
      pressanykey("³o­Ó«ÜÁV¿|³á..§A³o¼Ë¤£¦æ°Õ..");      
    }        
    d.money+=workmoney;
    d.workC+=1;
    return 0; 
...
/*  ¢u¢w¢w¢w¢w¢q¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢t*/    
    ...
    if(class>=95)
    {
      ...
      pressanykey("¤û¦Ïªøªº¦n¦n³á..§Æ±æ§A¦A¨ÓÀ°¦£...");
    }
    else if(class<95 && class>=80)
    {
      workmoney=210+(d.wrist*2+d.hp*2)/80;
      pressanykey("¨þ¨þ..ÁÙ¤£¿ù³á..:)");
    }    
    else if(class<80 && class>=60)
    {
      workmoney=160+(d.wrist*2+d.hp*2)/80;
      pressanykey("´¶´¶³q³q°Õ..¥i¥H§ó¦nªº..");      
    }    
    else if(class<60)
    {
      workmoney=120+(d.wrist*2+d.hp*2)/80;
      pressanykey("§A¤£¤Ó¾A¦X¹A³õªº¤u§@  -_-...");      
    }        
    d.money+=workmoney;
    d.workD+=1;
    return 0;
...
/*  ¢u¢w¢w¢w¢w¢q¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢t*/
    ...
    if(class>=80)
    {
      ...
      pressanykey("«È¤H³£»¡¤Ó¦n¦Y¤F..¦A¨Ó¤@½L§a...");
    }
    else if(class<80 && class>=60)
    {
      d.homework+=rand()%2+1;
...
/*  ¢u¢w¢w¢w¢w¢q¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢t*/
    ...
    {
      pressanykey("¤pÂû¤Ó¤p¤F,¤@·³¥H«á¦A¨Ó§a...");
      return 0;
    }
    workmoney=0;       
...
/*  ¢u¢w¢w¢w¢w¢q¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢t*/
    ...
    if((d.bbtime/60/30)<2)
    {
      pressanykey("¤pÂû¤Ó¤p¤F,¨â·³¥H«á¦A¨Ó§a...");
      return 0;
    }          
    workmoney=0;
    class=(d.hp*100/d.maxhp)-d.tired;            
...
/* ¢u¢w¢w¢w¢w¢q¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢t*/
    ...
    if(class>=75)
    {
       ...
       pressanykey("¤uµ{«Ü§¹¬ü  ÁÂÁÂ§A¤F..");
    }
    else if(class<75 && class>=50)  
    {
       workmoney=220+d.maxhp/45;    
       pressanykey("¤uµ{©|ºÙ¶¶§Q  ¨¯­W§A¤F..");
    }
    else if(class<50 && class>=25)  
    {
       workmoney=200+d.maxhp/40;    
       pressanykey("¤uµ{®t±j¤H·N  ¦A¥[ªo³á..");
    }    
    ...
    {
       workmoney=160;
       pressanykey("¤U¦¸Åé¤O¦n¤@ÂI..¯h³Ò«×§C¤@ÂI¦A¨Ó....");
    }
...
/*  ¢u¢w¢w¢w¢w¢q¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢t*/
    ...
    if((d.bbtime/60/30)<3)
    {
      pressanykey("¤pÂû²{¦bÁÙ¤Ó¤p¤F,¤T·³¥H«á¦A¨Ó§a...");
      return 0;
    }
    workmoney=0;
    class=(d.hp*100/d.maxhp)-d.tired;
...
/*  ¢u¢w¢w¢w¢w¢q¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢t*/
    ...
    move(4,0);
    show_job_pic(131);
    pressanykey("®a±Ð»´ÃP ·íµM¿ú´N¤Ö¤@ÂIÅo");
    d.workM+=1;
    return;
}
...
pip_marriage_offer()
{
   ...
   if(ans[0]=='y' || ans[0]=='Y')
   {
     if(d.wantend!=1 && d.wantend!=4)
     {
       ...
       {
         d.social+=10;
         pressanykey("ÁÙ¬Oºû«ùÂÂ±B¬ù¦n¤F..");
         return 0;
       }
     ...
     if(d.wantend<4)
        ...
        d.wantend=5;
     pressanykey("§Ú·Q¹ï¤è¬O¤@­Ó«Ü¦nªº¦ñ«Q..");
     now=time(0);
   ...
   else
   {
     ...
     d.relation+=20;
     if(d.wantend==1 || d.wantend==4)
	     pressanykey("§ÚÁÙ¦~»´  ¤ß±¡ÁÙ¤£©w...");
     else
     	     pressanykey("§Ú¦­¤w¦³±B¬ù¤F..¹ï¤£°_...");
   }
   d.money+=money;
   return 0;
}
...
pip_ending_screen()
{
  ...
  system(buf);
  pressanykey("±o¨ì %d ¤¸,%d ÂI¸gÅç­È",endgrade*10*ba,endgrade*10); 
...
pip_money()
{
  ...
  {
    getdata(18,0,"­n´«¦h¤Ö¿ú? ",ans,10,LCECHO,0);
    if(!ans[0]) return;
    money = atol(ans);
  }
  sprintf(buf,"¬O§_­nÂà´« %d ¤¸ ¬° %d Âûª÷? [y/N]",money,money/10);
  ...
  if(ans[0] == 'y')
  {
    ...
    d.money += (money/10);
    pip_write_file();
    sprintf(buf,"§A¨­¤W¦³ %d ¤¸,Âûª÷ %d ¤¸",cuser.silvermoney,d.money);
  }
  else
    sprintf(buf,"¨ú®ø.....");
